...
class ConfigHandler:
    def __init__(self):
        self.general_config = yaml.safe_load(open("data/all_configs/general_config.yaml", 'r'))
        self.default_data_augment = yaml.safe_load(open("data/all_configs/default_data_augment.yaml", 'r'))
        self.using_params = yaml.safe_load(open(os.path.join("data/all_configs", self.general_config['path']['using_params_name']), 'r'))
